...
<?php $pageTitle = 'NCFRS Records - Lagonglong FARMS'; include 'includes/layout_start.php'; ?>
                        ...
                        <div class="relative">
                            ...
                            <div id="navigationDropdown" class="absolute left-0 top-full mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 z-[60] hidden overflow-y-auto" style="max-height: 500px;">
                                ...
                                <div class="border-b border-gray-200">
                                    ...
                                    <a href="ncfrs_records.php" class="w-full text-left px-4 py-2 hover:bg-gray-100 flex items-center text-gray-700 bg-blue-50 border-l-4 border-blue-500 font-medium">
                ...
                <form method="POST" class="flex flex-col gap-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                <input type="text" name="search" id="ncfrs_search" value="<?php echo htmlspecialchars($search); ?>" 
                                       ...
                                       onfocus="showNCFRSSuggestions()"
                                       onblur="hideNCFRSSuggestions()">
                                    <input type="hidden" name="farmer_id" id="selected_ncfrs_farmer_id" value="<?php echo htmlspecialchars($farmer_id_filter); ?>">
                                <i class="fas fa-search absolute left-3 top-3 text-gray-400"></i>
                                
                                <!-- Auto-suggest dropdown -->
                                <div id="ncfrs_suggestions" class="absolute z-50 w-full bg-white border border-gray-300 rounded-lg shadow-lg mt-1 max-h-60 overflow-y-auto hidden">
                    ...
                    <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                        <div class="flex justify-between items-center">
                            ...
                            <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
                                <?php if ($page > 1): ?>
                                    <a href="ncfrs_records.php<?php echo buildUrlParams($page - 1, $search, $barangay_filter, $farmer_id_filter); ?>" 
                                ...
                                <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                                    <a href="ncfrs_records.php<?php echo buildUrlParams($i, $search, $barangay_filter, $farmer_id_filter); ?>" 
    ...
    <script>
        ...
        function exportToPDF() {
            ...
            let exportUrl = 'pdf_export.php?action=export_pdf&is_ncfrs=1';
        ...
        // Auto-suggest functionality for NCFRS farmer search
                        ...
                        data.farmers.forEach(farmer => {
                            html += `
                                <div class="px-3 py-2 hover:bg-gray-100 cursor-pointer border-b last:border-b-0" 
                                     onclick="selectNCFRSSuggestion('${farmer.farmer_id}', '${farmer.full_name.replace(/'/g, "\\'")}', '${farmer.contact_number}')">
        ...
        function selectNCFRSSuggestion(farmerId, farmerName, contactNumber) {
            const searchInput = document.getElementById('ncfrs_search');
            const selectedFarmerId = document.getElementById('selected_ncfrs_farmer_id');
            searchInput.value = farmerName;
            if (selectedFarmerId) {
                selectedFarmerId.value = farmerId;
            }
            hideNCFRSSuggestions();
        ...
        function showNCFRSSuggestions() {
            const searchInput = document.getElementById('ncfrs_search');
            if (searchInput.value.length >= 1) {
                searchNCFRSAutoSuggest(searchInput.value);
            }
        }

        function hideNCFRSSuggestions() {
            const suggestions = document.getElementById('ncfrs_suggestions');
            if (suggestions) {
                setTimeout(() => {
                    suggestions.classList.add('hidden');
