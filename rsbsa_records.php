...
?>
<?php $pageTitle = 'RSBSA Records - Lagonglong FARMS'; include 'includes/layout_start.php'; ?>
                            ...
                            <div class="relative">
                                ...
                                <div id="navigationDropdown" class="absolute left-0 top-full mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 z-[60] hidden overflow-y-auto" style="max-height: 500px;">
                                    ...
                                    <div class="border-b border-gray-200">
                                        ...
                                        <a href="rsbsa_records.php" class="w-full text-left px-4 py-2 hover:bg-gray-100 flex items-center text-gray-700 bg-blue-50 border-l-4 border-blue-500 font-medium">
